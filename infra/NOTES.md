...
## 2026-04-26 
Revisiting this note folder, I will reorganize this in the upcoming week. But I noticed the note from October 27 that talked about modules as a way to organize software. Tonight as I have been thinking about modules and creating modules as something that I think that I should do. I found myself reading Hashicorp's docs, specifically the page called [Creating Modules](https://developer.hashicorp.com/terraform/language/modules/develop), which gives an overview and best practices for creating modules.
